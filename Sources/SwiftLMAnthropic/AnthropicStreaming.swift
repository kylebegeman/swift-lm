...
extension AnthropicClient {
  ...
  private static func streamFailure(_ response: AnthropicHTTPStreamResponse) async -> LMClientError {
    var body = ""
    do {
  ...
  private static func process(
    ...
    continuation: AsyncThrowingStream<LMStreamEvent, any Error>.Continuation
  ) throws {
...
private struct AnthropicStreamState {
  ...
  mutating func finishBlock(at index: Int) -> LMToolCall? {
  ...
  func response(metadata: LMProviderMetadata) throws -> LMResponse {
