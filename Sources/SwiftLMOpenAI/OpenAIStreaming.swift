...
extension OpenAIClient {
  ...
  private static func streamFailure(_ response: OpenAIHTTPStreamResponse) async -> LMClientError {
    var body = ""
    do {
  ...
  private static func process(
    ...
    case "response.completed", "response.incomplete":
      ...
      state.completedResponse = try response.lmResponse(metadata: metadata)
