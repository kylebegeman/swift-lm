...
public enum LMPrivacyMode: String, CaseIterable, Codable, Equatable, Hashable, Sendable {
...
public enum LMProviderKind: String, CaseIterable, Codable, Equatable, Hashable, Sendable {
  case anthropic
...
public struct LMProviderMetadata: Codable, Equatable, Hashable, Sendable {
  ...
  public init(
    ...
    privacyMode: LMPrivacyMode,
    promptVersion: String,
    providerConfigurationID: String? = nil,
    providerDisplayName: String,
    providerKind: LMProviderKind
  ) {
...
public struct LMTokenUsage: Codable, Equatable, Hashable, Sendable {
...
public struct LMError: Error, Equatable, LocalizedError, Sendable {
