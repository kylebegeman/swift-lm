...
extension LMStep where Output == Input {
  ...
  public static func localRetrieval(
    ...
    Self(id: id, kind: .retrieval) { input, context in
      ...
      let plan = LMContextPlan(items: [contextItem])
      let budgetReport = LMWorkflowContextBudgetReport(
        id: "\(id)-budget",
        stepID: id,
      ...
      return LMStepResult(
        ...
        intermediateOutput: LMWorkflowIntermediateOutput(
          id: "\(id)-context",
          stepID: id,
...
extension LMStep where Output == CompiledPrompt {
...
extension LMStep {
  ...
  ) -> LMStep<CompiledPrompt, StructuredGenerationCandidate<Generated>> {
    LMStep<CompiledPrompt, StructuredGenerationCandidate<Generated>>(
      id: id,
      kind: .generation
    ) { prompt, context in
  ...
  ) -> LMStep<StructuredGenerationPipelineResult<Generated>, Generated> {
    LMStep<StructuredGenerationPipelineResult<Generated>, Generated>(
      id: id,
      kind: .repairFallback
    ) { result, _ in
      ...
      {
        return LMStepResult(output: output)
      }
      ...
      case .accepted, .failed, .fellBack:
        throw LMError("Workflow step \(id) could not repair or fall back.")
      }
    }
  }
}
